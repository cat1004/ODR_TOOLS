package com.beiming.evidenceplatform.config.swagger;
...
public class SwaggerAutoConfiguration implements BeanFactoryAware {
  ...
  public List<Docket> createRestApi(SwaggerProperties swaggerProperties) {
    ...
    for (String groupName : swaggerProperties.getDocket().keySet()) {
      ...
      ApiInfo apiInfo = new ApiInfoBuilder()
          .title(docketInfo.getTitle().isEmpty() ? swaggerProperties.getTitle()
              : docketInfo.getTitle())
          ...
          .contact(
              new Contact(
                  docketInfo.getContact().getName().isEmpty() ? swaggerProperties.getContact()
                      .getName() : docketInfo.getContact().getName(),
                  ...
                  docketInfo.getContact().getEmail().isEmpty() ? swaggerProperties.getContact()
                      .getEmail() : docketInfo.getContact().getEmail()
              )
          )
  ...
  private List<Parameter> assemblyGlobalOperationParameters(
    ...
    List<SwaggerProperties.GlobalOperationParameter> resultOperationParameters = Lists
        .newArrayList();
